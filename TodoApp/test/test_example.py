import pytest
# upewnij się że twój plik z testami zaczyna się od słowa test
# funlcja testująca rownież musi się zaczynać od słowa test
...
# zamiast inicjowania obiektu można użyć pytest fixture
